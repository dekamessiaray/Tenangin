...
/* Label untuk toggle Ya/Tidak kustom (menggantikan st.radio native yang
   rentan menampilkan overlay autofill/aksesibilitas bawaan OS/browser di
   beberapa perangkat mobile, karena elemen <input type="radio"> asli sudah
   tidak lagi dipakai sama sekali). */
.pill-toggle-label {
    font-size: 0.95rem;
    color: var(--ink);
    margin-bottom: 0.5rem;
...
@media (max-width: 640px) {
    ...
    /* Toggle Ya/Tidak: paksa tetap sebaris di mobile (kata pendek, selalu
       muat), jangan ikut perilaku stack vertikal bawaan Streamlit. */
    div[class*="st-key-toggle_"] div[data-testid="stHorizontalBlock"] {
        flex-wrap: nowrap !important;
        gap: 0.6rem !important;
    }
    div[class*="st-key-toggle_"] div[data-testid="stHorizontalBlock"] > div {
        min-width: 0 !important;
        flex: 1 1 auto !important;
    }
    div[class*="st-key-toggle_"] .stButton button {
